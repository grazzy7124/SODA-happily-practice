...
import 'package:ver1/eunji/profilefriend.dart';
import 'package:ver1/eunji/read.dart';
...
class WholePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        PageList(
          wholemain: 'assets/eunji/main/1.png',
          wholename: '보들이발닦개',
          wholeyear: '2025',
          wholemonth: '7',
          wholeday: '29',
          wholephoto: 'assets/eunji/mainlist/1.png',
          wholetitle: '보드리랑 산책',
        ...
        Divider(),
        PageList(
          wholemain: 'assets/eunji/main/2.png',
          wholename: '예은',
          wholeyear: '2025',
          wholemonth: '7',
          wholeday: '29',
          wholephoto: 'assets/eunji/mainlist/2.png',
        ...
        Divider(),
        PageList(
          wholemain: 'assets/eunji/main/3.png',
          wholename: '방구뽕',
          wholeyear: '2025',
          wholemonth: '7',
          wholeday: '29',
          wholephoto: 'assets/eunji/mainlist/3.png',
          wholetitle: '포은흥해도서관',
...
class FriendPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        PageList(
          wholemain: 'assets/eunji/main/4.png',
          wholename: '김철수',
          wholeyear: '2025',
          wholemonth: '7',
          wholeday: '24',
          wholephoto: 'assets/eunji/mainlist/4.png',
        ...
        Divider(),
        PageList(
          wholemain: 'assets/eunji/main/5.png',
          wholename: '박지수',
          wholeyear: '2025',
          wholemonth: '7',
          wholeday: '24',
          wholephoto: 'assets/eunji/mainlist/5.png',
          wholetitle: '폰케 바꿈',
