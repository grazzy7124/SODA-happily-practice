...
import 'package:ver1/view/mainPage/myDiary/mydiaryFirstType.dart';
import 'package:provider/provider.dart';
import 'package:ver1/provider/emotion_provider.dart';  // EmotionProvider 위치
...
class _FirstDiaryPageState extends State<FirstDiaryPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      double currentEmotion = context.read<EmotionProvider>().emotion.value;
      setState(() {
